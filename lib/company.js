...
const diccionario = [
    ...
    'eleva(d|t)or', 'embajada', 'embotelladora', 'empaque', 'empresa', 'endoscop(i|í)a', 'energ', 'engine', 'enterprise', 'entertainment', 'envase',
    ...
    'f(a|á)brica', 'factory', 'farmac', 'federal', 'fedex', 'ferreter', 'festival', 'fianza', 'fideicomiso', 'fiesta', 'filtro', '\\bfinal\\b', 'financ',
    ...
    'integra', '\\binter(a|b|c|f|k|m|n|s|v)', 'inventario', 'investiga', 'investor', 'inyecc',
    ...
    'power', 'precisi(o|ó)n', 'premium', 'presiden(cia|t)', 'print', 'privad', 'proces', 'produc', 'profe(c|s)s?ional', 'program', 'promo', 'pron(o|ó)stic',
    'property', 'protec', 'proveedor', 'pro(y|j)ect', 'proxy', 'publi(c|sh)?', 'purific',
    'quantum', 'qu(i|í)mic',
    ...
    'safety', 'satelital', 'science', 'script', 'secretar', 'securit', 'segur(idad|o)', 'seminar', 'serv\\b', 'servic', '\\bsiemens\\b', 'sindicato',
    ...
    'traducci(o|ó)n', 'traffic', 'transform', 'transport', 'tratamiento', 'travel', 'to?ur(i|í)s', 'training', 'tr(o|ó)nic', 'turbo', '\\btv\\b',
...
module.exports = function(string){
  ...
  //    CV, BV, SCP, RL
  if( string.match( /\s(sc|s\/c|s c|sa|s\/a|s a|cv|c\/v|c v|cc|c\/c|c c|bv|b\/v|b v|scp|rl|r\/l|r l|pcs|llc|lc|lp|llp|com|spd|nv|ag|slrc)$/i ) ) { return true }
