...
const diccionario = [
    ...
    'conserva(c|t)ion', 'consorcio?', '(c|k)onstruc', 'constit', 'consult', 'consumibles', 'contabilidad', 'contempor(a|á)ne', 'continental', 'contrac?t',
    ...
    'im(a|á)gen?', '(im)?permea(b|v)i?l', 'implement', 'import', 'impres', 'impuls', 'incorp', 'independ', '\\bind(i|í)gena\\b', '\\bindust', 'inform(a|á)ti(c|o|v)', 'infra',
    ...
    'limpieza', 'ling(u|ü)(i|í)stic', 'llantas', 'log(i|í)stic', '\\blogo', 'lubri', '\\bllantera\\b',
    ...
    'sub(a|á)rea', 'sucursal', 'suministro', 'supervis', 'supply', 'suprem(a|o)', 'surtidor', 'steakhouse', '\\be?studio\\b', 'synergy',
    ...
    'turbine', '\\btv\\b', '\\btrabajador', '\\btrabajo\\b',
